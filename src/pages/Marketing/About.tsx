  ...
  return (
    <div className="home-container">
      <section className="hero-section animate-fade-in">
        <h1 className="hero-title">About <span className="text-teal">HYG.3</span></h1>
        ...
        <div className="bento-grid">
          <div className="bento-card glass-panel col-span-12">
            ...
            <p className="text-muted leading-relaxed mb-6">
              Founded at the intersection of data science and clinical nutrition, HYG.3 was built on a simple premise: the human body generates millions of data points every day, yet we still prescribe supplements based on population averages.
            </p>
